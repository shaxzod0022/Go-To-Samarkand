...
const initialText = { en: "", ru: "", ja: "" };

const AddGallery: React.FC<AddGalleryProps> = ({ modal, onCancel }) => {
  ...
  const handleChange = (
    ...
    field: string,
    langKey?: keyof typeof initialText
  ) => {
    if (langKey) {
      setFormData({
        ...formData,
      ...
      <div className="mb-3">
        ...
        {["en", "uz", "ru", "ja"].map((lang) => (
          <input
            ...
            value={formData.title[lang as keyof typeof initialText]}
      ...
      <div className="mb-3">
        ...
        {["en", "uz", "ru", "ja"].map((lang) => (
          <textarea
            ...
            value={formData.description[lang as keyof typeof initialText]}
